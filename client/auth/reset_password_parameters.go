...
type ResetPasswordParams struct {
	...
	/*Body
	  Object with user email and redirect URL
...
func (o *ResetPasswordParams) WithBody(body *models.PasswordResetRequest) *ResetPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the reset password params
func (o *ResetPasswordParams) SetBody(body *models.PasswordResetRequest) {
	o.Body = body
}
