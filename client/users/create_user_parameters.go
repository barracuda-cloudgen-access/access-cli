...
type CreateUserParams struct {
	...
	/*User
	  Information about the user to create and whether to send an email invitation
...
func (o *CreateUserParams) WithUser(user CreateUserBody) *CreateUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the create user params
func (o *CreateUserParams) SetUser(user CreateUserBody) {
	o.User = user
}
