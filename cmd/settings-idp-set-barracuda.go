...
// setBarracudaIdpCmd represents the get command
var setBarracudaIdpCmd = &cobra.Command{
	Use:   "barracuda",
	Short: "Set barracuda idp configuration",
...
func init() {
	setIdpCmd.AddCommand(setBarracudaIdpCmd)

	initOutputFlags(setBarracudaIdpCmd)
	initTenantFlags(setBarracudaIdpCmd)
}
